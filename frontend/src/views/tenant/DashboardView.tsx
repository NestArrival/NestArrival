...
export default function DashboardView() {
    ...
    try {
      ...
      if (targetRoom) {
        ...
        fetchChatRooms().then((updatedRooms) => {
          const freshRoom = updatedRooms?.find(
            (r: any) => r.id === createdRoomId,
          );
  ...
  const hasPendingVerification =
    currentUser.verificationStatus === "PENDING_VERIFICATION";
      ...
      <div className="light-theme-dashboard fixed inset-0 z-50 flex items-center justify-center bg-[#f8fafc]/95 backdrop-blur-md p-6 text-center text-xs">
        <div className="bg-card-dark border border-red-200 p-8 rounded-2xl max-w-md w-full shadow-2xl space-y-6">
          <div className="flex flex-col items-center">
            ...
            <p className="text-[10px] text-red-500 uppercase tracking-widest font-extrabold mt-1">
              Banned Account
            </p>
          </div>
          ...
          <div className="bg-[#fdfbf7] border border-[#f4efe6] p-4 rounded-xl text-left leading-relaxed text-slate-650 space-y-1.5">
            ...
            <p className="italic">
              ...
              {currentUser.banReason ||
                "Violation of Community Safety Guidelines."}
              "
            </p>
          </div>

          <p className="text-[#8a7d6a] leading-normal">
            NestArrival enforces a zero-tolerance policy against fraudulent
            documentation, scam listings, or threat behaviors. For appeals or
            data claims, contact administration at:
          </p>

          <div className="pt-2">
            <a
              href="mailto:support@nestarrival.ca"
              className="inline-block text-[#cfa052] border border-[#cfa052]/20 bg-[#cfa052]/5 px-5 py-2.5 rounded-lg font-bold hover:bg-[#cfa052]/10 transition-colors"
            >
          ...
          <div className="pt-4 border-t border-[#f4efe6]">
            <button
              ...
              className="text-slate-400 hover:text-slate-700 font-bold flex items-center justify-center gap-1.5 w-full"
            >
      ...
      <aside className="hidden md:flex flex-col w-64 fixed inset-y-0 left-0 bg-sidebar-dark border-r border-contrast-dark z-30 p-6 justify-between">
        <div className="space-y-8">
          ...
          <div className="space-y-1">
            <span className="text-[9px] font-extrabold text-zinc-500 uppercase tracking-wider block px-2.5 mb-2">
              TENANT PORTAL
            </span>
        ...
        <div className="space-y-4 pt-4 border-t border-zinc-900/80">
          <div className="px-2">
            <span className="text-[9px] text-zinc-550 font-bold uppercase tracking-wider block mb-1">
              Tenant Profile
            </span>
          ...
          >
            ...
            >
              <div className="space-y-8 pt-16">
                <span className="text-[9px] font-extrabold text-[#d4ff4d] uppercase tracking-wider block px-2.5 mb-2">
                  TENANT PORTAL
                </span>
                <div className="space-y-1">
                  <button
              ...
              {activeTab === "search" && (
                <div className="space-y-6">
                  ...
                  <div className="bg-card-dark p-5 rounded-xl border border-contrast-dark shadow-xl grid grid-cols-1 sm:grid-cols-5 gap-4 items-end text-xs">
                    <div>
                      <label className="block font-bold mb-1.5 text-zinc-400">
                        City in Canada
                      </label>
                      <input
                        type="text"
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="2" className="bg-zinc-950">
                          2 Bedrooms
                        </option>
                  ...
                  {currentUser?.verificationStatus !== "VERIFIED" ? (
                    <div className="text-center py-20 bg-card-dark rounded-xl border border-contrast-dark flex flex-col items-center">
                      ...
                      <p className="text-zinc-400 text-sm max-w-md mx-auto leading-relaxed">
                        Get verified to view the listings. We maintain a 100%
                        scam-free network by ensuring all tenants and owners are
                        authenticated before browsing properties.
                      </p>
                      <Link
                        href="/tenant/verification"
                        className="mt-6 bg-[#cfa052] hover:bg-[#b58942] text-white px-6 py-2.5 rounded-lg font-bold transition-all shadow-[0_4px_10px_rgba(207,160,82,0.3)] hover:-translate-y-0.5"
                      >
                    ...
                    <div className="text-center py-16 bg-card-dark rounded-xl border border-contrast-dark">
                      <p className="text-zinc-500 text-sm">
                        No approved property listings matching your filters.
                      </p>
                    </div>
                  ) : (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {listings.map((item) => {
                        ...
                        return (
                          <div
                            key={item.id}
                            className="bg-card-dark border border-contrast-dark hover:border-[#cfa052]/30 hover:shadow-[0_0_15px_rgba(207,160,82,0.05)] transition-all flex flex-col justify-between overflow-hidden rounded-xl h-full"
                          >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 text-xs h-[550px]">
                  ...
                  <div className="lg:col-span-1 border border-contrast-dark bg-card-dark rounded-xl overflow-y-auto flex flex-col">
                    ...
                    <div className="flex-grow divide-y divide-zinc-950">
                      {chatRooms.length === 0 ? (
                        <p className="p-6 text-center text-zinc-500 italic">
                          No chat connections established.
                        </p>
                      ) : (
                        chatRooms.map((room) => (
                          <button
                            ...
                            className={`w-full text-left p-4 flex flex-col gap-1 transition-all cursor-pointer ${
                              activeRoom?.id === room.id
                                ? "bg-[#d4ff4d]/[0.02] border-l-2 border-[#d4ff4d]"
                          ...
                          >
                            ...
                            {room.messages[0] && (
                              <p className="text-[10px] text-zinc-500 line-clamp-1 italic mt-1">
                    ...
                    {activeRoom ? (
                      <>
                        ...
                        <div className="p-4 border-b border-contrast-dark bg-zinc-950/40 flex items-center justify-between">
                          <div>
                            <span className="font-bold text-white text-sm">
                              {activeRoom.owner.fullName}
                            </span>
                            <p className="text-[10px] text-zinc-550 mt-0.5">
                              Regarding: {activeRoom.listing.title}
                            </p>
                          </div>
                        ...
                        <form
                          ...
                          className="p-3 border-t border-contrast-dark flex gap-2 bg-zinc-950"
                        >
                          <input
                            type="text"
                            required
                      ...
                      <div className="flex-grow flex flex-col items-center justify-center text-zinc-550 p-8 text-center bg-black/10">
                        ...
                        <p>
                          Select a chat connection from the sidebar or approach
                          an owner on a property listing card to start
                          messaging.
                        </p>
                      </div>
                    )}
                  ...
                  {currentUser?.verificationStatus !== "VERIFIED" ? (
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      {savedListings.map((item) => (
                        <div
                          key={item.id}
                          className="bg-card-dark border border-contrast-dark hover:border-[#cfa052]/30 transition-all flex flex-col justify-between overflow-hidden text-xs rounded-xl"
                        >
                    ...
                    <div className="bg-card-dark p-6 rounded-xl border border-contrast-dark shadow-xl space-y-4">
                      ...
                      {currentUser.subscription ? (
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                          <div className="rounded-lg bg-zinc-950 border border-contrast-dark p-4 space-y-1">
                            ...
                            <p className="text-[10px] text-zinc-450">
                              Purchased for CAD $
                              {currentUser.subscription.price} on{" "}
                              {new Date(
                          ...
                          <div className="rounded-lg bg-zinc-950 border border-contrast-dark p-4 space-y-1">
                            ...
                            <p className="text-sm font-bold text-white">
                              {currentUser.subscription.approachesAllowed ===
                              -1 ? (
                                "Unlimited"
                              ) : (
                                <span>
                        ...
                        <div className="rounded-xl bg-zinc-950 border border-contrast-dark p-6 text-center text-zinc-400">
                          <p>
                            No active subscription plan found. Purchase a plan
                            below to unlock messaging with property owners.
                          </p>
                        </div>
                      )}
                    </div>
                      ...
                      >
                        ...
                        <label className="flex items-start space-x-2 bg-zinc-950 border border-contrast-dark p-3.5 rounded-xl cursor-pointer">
                          <input
                            ...
                            onChange={(e) =>
                              setPurchaseUrgent(e.target.checked)
                            }
                          ...
                          <div>
                            <p className="font-bold text-white flex items-center gap-1 text-[11px]">
                              ...
                              <span>
                                Premium Upgrade: Urgent Housing Match (+CAD $99)
                              </span>
                            </p>
                            <p className="text-[10px] text-zinc-500 mt-0.5">
                              Priority profile display inside owner list hubs,
                              boosting matching odds within 72 hours.
                            </p>
                          </div>
                        </label>
                        ...
                        <div className="bg-zinc-950 border border-contrast-dark p-4 rounded-xl text-[10px] text-zinc-400 space-y-2">
                          ...
                          {purchaseUrgent && (
                            <p>
                              - Urgent Relocation Boost:{" "}
                              <strong>CAD $99</strong>
                            </p>
                          )}
                  ...
                  <div className="lg:col-span-1">
                    <div className="bg-card-dark p-6 rounded-xl border border-contrast-dark shadow-xl space-y-4">
                      ...
                      <p className="text-xs text-zinc-500 leading-relaxed">
                        Under NestArrival safety policy, if you purchase a plan
                        and receive zero (0) responses from property owners
                        during your active period, you can apply for a full
                        refund of that billing cycle.
                      </p>
          ...
          <div className="bg-card-dark w-full max-w-lg rounded-2xl border border-contrast-dark p-6 shadow-2xl relative max-h-[90vh] overflow-y-auto flex flex-col justify-between">
            ...
            <div className="mt-2">
              ...
              <div className="flex items-center space-x-2 mb-4">
                <span className="inline-flex items-center space-x-1 text-zinc-400 font-bold uppercase">
                  ...
                  <span>
                    {selectedListing.location}, {selectedListing.city}
                  </span>
                </span>
              ...
              <div className="space-y-1 mb-6 text-zinc-400 leading-relaxed">
                ...
                <p className="text-zinc-350 leading-relaxed whitespace-pre-wrap">
            ...
            <div className="border-t border-contrast-dark pt-4">
              {isVerified ? (
                currentUser.subscription ? (
                  <form
                    onSubmit={handleInitiateApproach}
                    className="space-y-3.5"
                  >
                    <div className="rounded-lg bg-[#d4ff4d]/5 border border-[#d4ff4d]/10 p-3.5 text-[#d4ff4d] font-bold text-[11px] leading-relaxed">
                      Contact Vetted Landlord. This initial connection will
                      deduct <strong>1 approach credit</strong> from your
                      subscription.
                    </div>
                    <div>
                      <label className="block text-zinc-400 font-bold mb-1.5">
                  ...
                  <div className="rounded-xl bg-zinc-950 p-4 border border-contrast-dark text-zinc-400 text-center font-bold">
                    <p className="mb-2">
                      You need an active subscription package to approach
                      property owners.
                    </p>
                    <button
                      onClick={() => {
                ...
                <div className="rounded-xl bg-zinc-950 p-4 border border-contrast-dark text-zinc-500 text-center italic font-bold">
                  <p>
                    Only verified tenants can contact property owners. Please
                    submit your relocation documents in the dashboard
